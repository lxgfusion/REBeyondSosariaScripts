...
VENDORS = [
    {
        ...
        "folder":  ['RO'],
        "point":   'RO',
        # Observed: name "Davin the Resource Gatherer", no tooltip properties.
    ...
    },
    {
        ...
        "folder":  ['TamingDeed'],
        "point":   'TamingDeed',
        # Observed: name "Sherri", tooltip "Animal Trainer" / "Quest Giver".
        # Matching the title, not the given name.
    ...
    },
    {
        ...
        "folder":  ['Inscription'],
        "point":   'Inscription',
        # Observed: name "Edie", tooltip "Scribe". The old "Sahale the scribe"
        # is gone, which is why matching on the title matters.
        "names":   ["Scribe"],
        "context": ["Bulk Order Info", "Bulk Order", "Talk"],
        # Tried in order. Confirmed in-game: a SMALL bulk order opens
        # 0x9BADE6EA, a LARGE one (multiple items) opens 0xBE0DAD1E. Both take
        # button 1. If a third variant ever shows up the log names the id that
        # opened so it can be added here.
